...
public class CourseController {
	...
	public ResponseEntity<CourseResponse> addCourse(@RequestBody Course course, @PathVariable String topicId){
    ...
    public ResponseEntity<CourseResponse> updateCourse(@RequestBody Course course, @PathVariable String topicId, @PathVariable Long id) {
        course.setTopic(new Topic(topicId, "",""));
